...
class _MainDhikrCounterState extends State<MainDhikrCounter>
  ...
  late Map<String, List<String>> _keywordCache;
  late Map<String, String> _cleanedKeywordCache;
  late Set<String> _fillerWords;
  late RegExp _fillerWordsRegex;
  late RegExp _extraSpacesRegex;
  ...
  void _startVoiceRecognition() {
    ...
    try {
      _speechToText.listen(
        ...
        listenFor: Duration(seconds: Platform.isIOS ? 5 : 5), // Longer for iOS
        pauseFor: Duration(
          seconds: Platform.isIOS ? 4 : 3,
        ), // Longer pause for iOS
        partialResults:
            Platform.isIOS ? true : false, // Enable partial results for iOS
        ...
        listenMode:
            Platform.isIOS
                ? stt
                    .ListenMode
                    .dictation // iOS works better with dictation
  ...
  void _handleVoicePhraseDetected() {
    ...
    _voiceProcessingTimer = Timer(const Duration(milliseconds: 300), () {
      if (mounted) {
